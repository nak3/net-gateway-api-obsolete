...
func Get(ctx context.Context, selector string) v1alpha1.BackendPolicyInformer {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/nak3/net-gateway-api/pkg/client/gatewayapi/informers/externalversions/apis/v1alpha1.BackendPolicyInformer with selector %s from context.", selector)
	}
